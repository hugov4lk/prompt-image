...
import com.wokecustoms.prompt.image.AbstractTest;
...
import com.wokecustoms.prompt.image.repository.entity.Car;

@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
class CarControllerIntegrationTest extends AbstractControllerIntegrationTest {

    private static final String CAR_POST_REQUEST_BODY = AbstractTest.readFileToString("controller/car/post-request-body.json");
    private static final String CAR_PUT_REQUEST_BODY = AbstractTest.readFileToString("controller/car/put-request-body.json");
