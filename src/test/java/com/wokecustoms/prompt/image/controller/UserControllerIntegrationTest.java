...
class UserControllerIntegrationTest extends AbstractControllerIntegrationTest {
    ...
    private static final String USER_POST_REQUEST_BODY = AbstractTest.readFileToString("controller/user/post-request-body.json");
    private static final String USER_PUT_REQUEST_BODY = AbstractTest.readFileToString("controller/user/put-request-body.json");
